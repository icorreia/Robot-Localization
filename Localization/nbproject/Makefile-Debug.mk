...
${OBJECTDIR}/MotionModel.o: MotionModel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/MotionModel.o MotionModel.cpp

${OBJECTDIR}/TestBench.o: TestBench.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/TestBench.o TestBench.cpp
...
${OBJECTDIR}/Localizer.o: Localizer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/Localizer.o Localizer.cpp
